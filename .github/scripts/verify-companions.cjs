...
(async()=>{
 ...
 try{
  ...
  assert.ok(source.includes('rail-plan-count'),"Today Plan step indicator missing");
  assert.ok(source.includes('rail-catalog-track'),"Curriculum progress indicator missing");
  ...
  assert.ok(!plan.includes('className="rail-momentum"'),"momentum must not remain in left rail");
  ...
  for(const token of ["home-momentum","rail-momentum-track","rail-momentum-next","rail-momentum-review","completedPathCount","nextLesson.title","dueMistakes.length"])assert.ok(wideMomentum.includes(token),"wide panel lost real progress content: "+token);
  ...
  const homeMarkup="<!doctype html><html><head><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"></head><body><div class=\"app-shell\"><main class=\"workspace view-practice workspace-home\"><aside class=\"lesson-rail home-rail\"><h1>One step at a time.</h1><section class=\"rail-group rail-plan\"><div class=\"rail-group-heading\"><span class=\"rail-group-label\">01 · TODAY&#39;S PLAN</span><span class=\"rail-plan-count\">3 steps · one clear route</span><h2>Practice in order</h2><p>Daily actions</p></div><ol class=\"today-route\"><li class=\"is-current\"><button><span>1</span><div class=\"route-task-copy\"><strong>Continue lesson</strong><small>Keep learning Korean today</small><em>Open lesson →</em></div></button></li><li><button><span>2</span><div class=\"route-task-copy\"><strong>Vocabulary</strong><small>Practice new words</small><em>Open vocabulary →</em></div></button></li><li><button><span>3</span><div class=\"route-task-copy\"><strong>Grammar</strong><small>Review patterns</small><em>Open grammar →</em></div></button></li></ol></section><section class=\"rail-group rail-catalog\"><div class=\"rail-group-heading\"><span class=\"rail-group-label\">02 · YOUR CURRICULUM</span><span class=\"rail-catalog-kicker\">YOUR LEARNING LIBRARY</span><h2>All lessons</h2><p>Open catalog</p></div><button class=\"curriculum-button rail-destination\"><span>Browse lesson catalog<small>2 of 40 completed</small><span class=\"rail-catalog-track\" role=\"progressbar\" aria-valuenow=\"2\" aria-valuemin=\"0\" aria-valuemax=\"40\"><i style=\"width:5%\"></i></span></span><strong>↗</strong></button></section></aside><section class=\"lab home-dashboard\"><h2>Welcome back.</h2><section class=\"continue-panel\"><h3>Continue learning</h3></section><section class=\"real-korean\"><h3>Real Korean</h3></section></section><aside class=\"coach home-coach\"><div class=\"coach-head\"><div class=\"coach-orb\"><span></span><span></span><span></span></div><div><span class=\"section-label\">04 · ADAPTIVE COACH</span><h2>Reading your pattern</h2></div></div><div class=\"coach-note\"><p class=\"coach-lead\">Your route today</p><button class=\"why-button\">Personalize route</button></div><div class=\"signal-card\"><div class=\"signal-title\"><h3>Your live signals</h3><span>saved locally</span></div><div class=\"signal-row\"><span>Vocabulary</span><div><i style=\"--score:40%\"></i></div><strong>Growing</strong></div><div class=\"signal-row\"><span>Grammar</span><div><i style=\"--score:30%\"></i></div><strong>Building</strong></div></div><div class=\"next-card\"><span class=\"section-label\">Current focus</span><p><strong>Grammar</strong><br>Practice a pattern</p><button>Practice grammar</button></div></aside><section class=\"home-momentum rail-momentum\"><div class=\"home-momentum-header\"><div class=\"home-momentum-intro\"><div class=\"rail-momentum-head\"><span class=\"rail-group-label\">03 · YOUR MOMENTUM</span><span class=\"rail-momentum-spark\">↗</span></div><h2>One chapter closer.</h2><p>Based on completed lessons.</p></div><div class=\"home-momentum-path\"><strong>2 / 40</strong><span>YOUR LEARNING PATH</span></div></div><div class=\"home-momentum-grid\"><div class=\"rail-momentum-chapter\"><div class=\"rail-momentum-topline\"><span>UNIT 2 · CURRENT CHAPTER</span><strong>2<small> / 5</small></strong></div><strong class=\"rail-momentum-chapter-name\">My everyday life</strong><div class=\"rail-momentum-track\" role=\"progressbar\" aria-label=\"Current chapter lessons completed\" aria-valuenow=\"2\" aria-valuemin=\"0\" aria-valuemax=\"5\"><i style=\"transform:scaleX(.4)\"></i></div><div class=\"rail-momentum-markers\"><span class=\"is-done\"></span><span class=\"is-done\"></span><span class=\"is-next\"></span><span></span><span></span></div><span class=\"rail-momentum-counter\">3 chapter steps to go</span></div><div class=\"home-momentum-actions\"><button class=\"rail-momentum-next\"><span><small>UP NEXT · LESSON 3</small><strong>What I like</strong><em>Continue learning →</em></span><span class=\"rail-momentum-arrow\">↗</span></button><button class=\"rail-momentum-review\"><span><strong>2 due for review</strong><small>Revisit missed words</small></span><span>→</span></button></div></div></section><section class=\"study-hub study-hub-wide\"><div class=\"study-title\"><h3>Study it directly, then test it.</h3></div><div class=\"study-cards\">"+cardNames.map(([klass,label])=>'<a class="'+klass+'" href="/companions"><span class="study-glyph">가</span><span><strong>'+label+'</strong><small>Learn in a dedicated way.</small></span><em>Study now →</em></a>').join("")+["Vocabulary","Grammar","Test"].map(label=>'<button><span class="study-glyph">문</span><span><strong>'+label+'</strong><small>Study directly.</small></span><em>Open →</em></button>').join("")+"</div></section></main></div></body></html>";
  for(const width of [1440,1180,1024,820,620,390,320]){
    ...
    assert.ok(home.momentum.x>=home.lab.x-1,"momentum should start to right of left rail at "+width);
