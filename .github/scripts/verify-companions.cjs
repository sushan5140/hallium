...
(async()=>{
 ...
 try{
  ...
  console.log("PASS: wide momentum fills center/right dashboard, left rail simplified, lower Structured Study retained at 320–1440px");
