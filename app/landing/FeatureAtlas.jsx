...
export function HallimFeatureSystem({authHref}){
 ...
 return <div className={s.wrap} id="features">
  ...
  <section className={s.extras}><div className={s.extrasIntro}><p className={s.eyebrow}>06 / AND THE REST OF YOUR WORLD</p><h2>Learning isn't only<br/>what happens in lessons.</h2></div><div className={s.extrasGrid}><a href="/hangul"><strong lang="ko">가 나 다</strong><h3>Hangul Lab</h3><p>Begin with the script: letters, syllables, sound and writing practice.</p><span>Explore the writing system ↗</span></a><a href={authHref("/?view=partner")}><strong lang="ko">뭐 해?</strong><h3>Real Korean</h3><p>A phrase bank for everyday check-ins, affection, care, and casual situations—with usage notes.</p><span>Learn what people really say ↗</span></a><a href="/study-partners"><strong>↔ ✳</strong><h3>Study Partners</h3><p>Opt-in matching, mutual requests, private notes, shared rooms and three-round practice from shared material.</p><span>Discover complementary learners ↗</span></a><a href="/flashcards"><strong>▤ ♡</strong><h3>Starter flashcards</h3><p>Another way to meet and revisit introductory Korean vocabulary.</p><span>Open the flashcards ↗</span></a></div></section>
 </div>
}
