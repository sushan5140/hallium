...
export const ownerExceptionNotes = {
  ...
  7:{
    grammar:[
      ...
      note("Conjugation vs noun request","돕다→도와 주세요 (ㅂ irregular); 하다→해 주세요. ‘커피 주세요’ asks for an item; ‘커피를 만들어 주세요’ asks for an action.","저를 도와 주세요. / 커피를 만들어 주세요.")
    ],
    vocab:{
  ...
  16:{
    ...
    vocab:{
      ...
      "조용하다":note("Usage & word form","조용하다 describes a quiet state; the request ‘Be quiet’ commonly uses 조용히 하세요 (조용히 is the adverb).","여기는 조용해요. / 조용히 하세요."),
